  ...
  return (
    <nav className='w-full h-[10vh] px-4 md:px-8 py-3 flex items-center justify-between fixed top-0 left-0 z-[100] bg-white border-b border-gray-100 shadow-sm'>
      ...
      <div className='flex items-center gap-6 lg:gap-12'>
        ...
        {/* Desktop Nav - Optimized for your specific CRUD/Orders/Products flow */}
        <ul className='hidden xl:flex items-center gap-8 text-[11px] uppercase tracking-[0.2em] font-black'>
