    ...
    <div id='contact' className='scroll-mt-[10vh] w-[80%] m-auto border-0 bg-gray-50 p-5 rounded-xl shadow-md shadow-gray-400 mt-[50px] flex justify-content-around'>
        <div className='w-[50%] flex flex-col items-center'>
            ...
            <div className='flex flex-col justify-center items-center pt-5'>
                <p className='text-[22px]'><span className='font-bold'>Email: </span>scntthefragrance@gmail.com</p>
                <p className='text-[22px]'><span className='font-bold'>Social: </span>scntTheFragrance (Instagram)</p>
                <p className='text-[22px]'>Scnt.- The Fragrance (Facebook)</p>
                <p className='text-[22px]'><span className='font-bold'>Location: </span>Phnom Penh, Cambodia</p>
            </div>           
        </div>
        <div className='w-[50%] flex flex-col justify-center items-center'>
            <h1 className='font-bold text-[30px] text-center'>Send Us a Message</h1>
